...
namespace EFBook
{
    ...
    public class AccountController : Controller
    {
        ...
        {
            //var role = new CodeFirstRoleProvider();
            //role.CreateRole("Admin");
            //role.CreateRole("NonAdmin");
        ...
        public ActionResult Register(RegisterModel model)
        {
            ...
            {
                // Attempt to register the user
                if (model.AccountType == "admin1234")
                {
                    try
                    {
                        WebSecurity.Register(model.UserName, model.Password, model.Email, true, model.FirstName, model.LastName);
                        Roles.AddUserToRole(model.UserName, "Admin");
                        //WebSecurity.CreateUserAndAccount(model.UserName, model.Password);
                        WebSecurity.Login(model.UserName, model.Password);
                        ADMINISTRATOR admin = new ADMINISTRATOR();
                        admin.Pword = model.Password;
                        admin.FName = model.FirstName;
                        admin.LName = model.LastName;
                        admin.LoginStatus = "Logged In";
